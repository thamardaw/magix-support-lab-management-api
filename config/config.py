...
class Settings:
    ...
    DATABASE_URL = os.getenv("DATABASE_URL") or "postgresql://postgres:postgres@localhost:5432/lab" # heroku postgres comes with one line database url
    ...
    DATABASE_URL_ALEMBIC = os.getenv("DATABASE_URL") or "postgresql://postgres:postgres@localhost:5432/lab" # heroku postgres comes with one line database url
